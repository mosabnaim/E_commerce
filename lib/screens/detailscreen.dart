  ...
  Widget _buildDiscription() {
    return Container(
      ...
      child: Wrap(
        children: <Widget>[
          Text(
            "This is a beautiful product that is used to increase comfort and increase the elegance of the person who wears it. It reflects the civilization of this country and the culture of its producing cities. We have new discounts on this product up to 30% and more for the product, choose the quantity and size, press add to cart and confirm the order. ",
